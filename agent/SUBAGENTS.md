...
Do not pass `model` unless debugging. Flash workers use OpenCode Flash, then
ClinePass Flash if OpenCode is unauthed or out of usage. `vision` uses Luna,
then ClinePass MiMo. The lead model is never switched.
